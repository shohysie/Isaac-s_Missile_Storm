...
If you've installed the MOD IWD1_EET and IWD2_EET, the notes can be purchased at:
  Orrick (Kuldahar)
...
这个MOD将艾萨克飞弹风暴系列法术添加到博德之门游戏中。仅增强版游戏可用。
安装后在下列商店可以购买艾萨克的法术笔记进行学习：
  泰蓝提尔（高篱堡）、哈巴瑟·德林（巫术杂货店，仅龙矛）、利博德（冒险者集市）、拉札卢斯·李巴卢斯（萨拉督许）
如果安装了IWD1_EET、IWD2_EET，还可以在下列商店购买：
  灰袍欧瑞克Orrick（库达哈Kuldahar）、伊蕾瑟拉Elytharra（塔尔歌斯城Targos Town）
